...
type ModelLicense struct {
	...
	KengineSupportEmail *string `json:"kengine_support_email,omitempty"`
...
// GetKengineSupportEmail returns the KengineSupportEmail field value if set, zero value otherwise.
func (o *ModelLicense) GetKengineSupportEmail() string {
	if o == nil || IsNil(o.KengineSupportEmail) {
		var ret string
		return ret
	}
	return *o.KengineSupportEmail
}

// GetKengineSupportEmailOk returns a tuple with the KengineSupportEmail field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ModelLicense) GetKengineSupportEmailOk() (*string, bool) {
	if o == nil || IsNil(o.KengineSupportEmail) {
		return nil, false
	}
	return o.KengineSupportEmail, true
}
...
// SetKengineSupportEmail gets a reference to the given string and assigns it to the KengineSupportEmail field.
func (o *ModelLicense) SetKengineSupportEmail(v string) {
	o.KengineSupportEmail = &v
}
...
func (o ModelLicense) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.KengineSupportEmail) {
		toSerialize["kengine_support_email"] = o.KengineSupportEmail
	}
